# iPhone alert bot (OLX + Vinted -> Discord)

Sprawdza co 10 minut nowe ogloszenia z OLX i Vinted zawierajace iPhone
11 lub nowszy i wysyla je na kanal Discord jako powiadomienie. Dziala
w calosci na GitHub Actions - nie trzeba niczego trzymac wlaczonego.
...
- **Filtrowanie modelu** jest w pliku `check_offers.py` w zmiennej
  `MODEL_PATTERN` - obecnie lapie "iPhone 11" wzwyz (wraz z Pro/Max/Mini
  itd.). Chcesz zawezic/rozszerzyc? Zmien regex tam.
